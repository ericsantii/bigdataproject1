...
public class OccMapper extends Mapper<LongWritable, Text, Text, IntWritable> {

    @Override
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {

        ObjectMapper mapper = new ObjectMapper();
        TweetParserO tweet = mapper.readValue(value.toString(), TweetParserO.class);
        ...
        List<String> wordstofind = new ArrayList<>(Arrays.asList("trump", "flu", "zika","diarrhea","ebola","headache","measles"));
